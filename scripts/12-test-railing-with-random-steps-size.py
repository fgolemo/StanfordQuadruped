...
STEP_DEPTH = [0.2, 0.4]  # if you're stepping onto one step, how much of your foot can fit on the step?
STEP_HEIGHT = [0.03, 0.05]  # how far for you have to go up between each step?
OFFSET = (0.3, 0, 0)
