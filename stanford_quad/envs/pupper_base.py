...
class PupperBase(gym.Env):
    ...
    def _get_obs(self):
        """
        :return: The state that the agent will have to take action.
        """
    ...
    def _get_reward(self, action):
        ...
        reward_run = (pos_after[0] - self.old_pos[0]) / self.dt
    ...
    def _get_info(self):
        """
        :return: Extra info not used in the policy.
        """
        return {}

    def _get_done(self):
        """
        :return: Boolean that tell us if the episode is finished.
        """
        done = False
        self.episode_steps += 1
    ...
    def sanitize_actions(self, actions):
        """
        :param actions: Raw actions
        :return: Sanitized action: Scaled, clipped, incremental/relative
        """
